CREATE DATABASE  IF NOT EXISTS `dublinbike` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `dublinbike`;
-- MySQL dump 10.13  Distrib 8.0.19, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: dublinbike
-- ------------------------------------------------------
...
CREATE TABLE `dublin_bike_dynamicdata` (
  ...
  CONSTRAINT `number` FOREIGN KEY (`number`) REFERENCES `dublin_bike_staticdata` (`number`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `open_weather_dynamicdata` (
  ...
  `weather.main` varchar(16) NOT NULL,
  `weather.discription` varchar(32) NOT NULL,
  `weather.icon` varchar(16) NOT NULL,
  ...
  `sys.sunrise` timestamp NOT NULL,
  `sys.sunset` timestamp NOT NULL,
...
--
-- Dumping events for database 'dublinbike'
--

--
-- Dumping routines for database 'dublinbike'
--
...
-- Dump completed on 2020-02-24 17:11:00
